...
class UserRoleCotroller {
  ...
  createUserRole = async (req, res) => {
    ...
    try {
      ...
      const result = JSON.parse(
        await this.userRoleModle.createUserRole(role_name)
      ).recordset;
      res.status(200).json({
  ...
  getAllUserRole = async (req, res) => {
    ...
    try {
      const result = JSON.parse(
        await this.userRoleModle.getAllUserRole()
      ).recordset;
      res.status(200).json({
  ...
  updateUserRole = async (req, res) => {
    ...
    try {
      ...
      const result = JSON.parse(
        await this.userRoleModle.updateUserRole(role_id, role_name)
      ).recordset;
      res.status(200).json({
  ...
  deleteUserRole = async (req, res) => {
    ...
    try {
      ...
      const result = JSON.parse(
        await this.userRoleModle.deleteUserRole(role_id)
      ).recordset;
      res.status(200).json({
